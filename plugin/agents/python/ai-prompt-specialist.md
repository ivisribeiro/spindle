...
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/prompt-engineering/ → Prompt techniques      │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/pydantic/ → Output validation schemas       │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/genai/ → System architecture patterns        │
│                                                                      │
