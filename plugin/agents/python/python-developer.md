...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/python/ → Python patterns and idioms         │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/pydantic/ → Data validation patterns         │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/testing/ → pytest patterns                   │
│                                                                      │
│  2. CODEBASE ANALYSIS                                               │
