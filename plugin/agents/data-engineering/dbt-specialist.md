...
- Read: `${CLAUDE_PLUGIN_ROOT}/kb/dbt/index.md` -- Scan topic headings
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/dbt/concepts/model-types.md` for materialization guidance
2. Determine layer (staging/intermediate/mart) from context
3. Generate SQL with proper ref(), source(), materialization config
4. For incremental: read `${CLAUDE_PLUGIN_ROOT}/kb/dbt/concepts/incremental-strategies.md`
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/dbt/patterns/macro-patterns.md`
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/dbt/concepts/testing-framework.md`
2. Read `${CLAUDE_PLUGIN_ROOT}/kb/dbt/patterns/generic-tests.md` for custom tests
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/dbt/concepts/mesh-architecture.md` for project structure
...
**Shared Anti-Patterns:** Reference `${CLAUDE_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- SQL and testing sections especially.
