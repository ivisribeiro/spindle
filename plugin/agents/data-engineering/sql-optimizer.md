...
- Read: `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/index.md` -- Scan topic headings
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/concepts/cte-patterns.md` for restructuring
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/concepts/window-functions.md`
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/patterns/deduplication.md`
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/patterns/cross-dialect.md`
...
**Process:**
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/patterns/gap-and-island.md` or `${CLAUDE_PLUGIN_ROOT}/kb/sql-patterns/patterns/pivot-unpivot.md`
...
**Shared Anti-Patterns:** Reference `${CLAUDE_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- SQL section.
