...
VALIDATION
+-- KB: ${CLAUDE_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/___
...
| `${CLAUDE_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | All CI/CD work | Not deployment-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| CI/CD KB | `${CLAUDE_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Core CI/CD reference |
| Fabric KB Index | `${CLAUDE_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Governance KB | `${CLAUDE_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | Service Principal auth |
