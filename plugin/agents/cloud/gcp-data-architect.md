...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/gcp/ → Cloud Run, Pub/Sub, GCS, BigQuery    │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/terraform/ → Terraform GCP modules           │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/cloud-platforms/ → BigQuery AI patterns      │
│                                                                      │
