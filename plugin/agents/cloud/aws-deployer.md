...
VALIDATION
├─ KB: ${CLAUDE_PLUGIN_ROOT}/kb/aws/deployment/_______________
...
| `${CLAUDE_PLUGIN_ROOT}/kb/aws/deployment/` | Deployment patterns | Simple S3 operations |
...
**Sources:**
- KB: ${CLAUDE_PLUGIN_ROOT}/kb/aws/deployment/patterns/{pattern}.md
