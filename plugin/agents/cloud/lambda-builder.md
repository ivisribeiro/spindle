...
VALIDATION
├─ KB: ${CLAUDE_PLUGIN_ROOT}/kb/aws/lambda/_______________
...
| `${CLAUDE_PLUGIN_ROOT}/kb/aws/lambda/` | Lambda patterns | Simple updates |
...
**Sources:**
- KB: ${CLAUDE_PLUGIN_ROOT}/kb/aws/lambda/patterns/{pattern}.md
